# -*- coding: utf-8 -*-
"""
Created on Thu Dec 29 05:33:08 2022
...
dataframe = pd.read_excel("C:/Users/polyt/Desktop/dataframe_with_queries.xls").take([2,20], axis=1)
...
results18 = w18.groupby([
    'Κατά την εμπειρία σας, ήταν αποτελεσματική η λήψη συμπληρωμάτων διατροφής;'
    ]).size()
