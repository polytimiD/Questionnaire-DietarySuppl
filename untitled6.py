# -*- coding: utf-8 -*-
"""
Created on Thu Dec 29 05:28:40 2022
...
dataframe = pd.read_excel("C:/Users/polyt/Desktop/dataframe_with_queries.xls").take([2,18], axis=1)
...
results18 = w18.groupby([
    'Σε ποιο βαθμό πιστεύετε ότι είναι επιστημονικά τεκμηριωμένη η χορήγηση συμπληρωμάτων διατροφής;'
    ]).size()
