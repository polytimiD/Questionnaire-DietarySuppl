# -*- coding: utf-8 -*-
"""
Created on Thu Dec 29 06:28:34 2022
...
dataframe = pd.read_excel("C:/Users/polyt/Desktop/dataframe_with_queries.xls").take([2,19], axis=1)
...
results18 = w18.groupby([
    'Σε ποιο βαθμό πιστεύετε ότι μια ισορροπημένη διατροφή αρκεί και μπορεί να καλύψει τις ανάγκες του οργανισμού χωρίς να λαμβάνονται επιπρόσθετα συμπληρώματα διατροφής;'
    ]).size()
