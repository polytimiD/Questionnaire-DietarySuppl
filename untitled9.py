# -*- coding: utf-8 -*-
"""
Created on Thu Dec 29 05:45:04 2022
...
dataframe = pd.read_excel("C:/Users/polyt/Desktop/dataframe_with_queries.xls").take([2,23], axis=1)
...
results18 = w18.groupby([
    'Συνολικά, πιστεύετε ότι τα συμπληρώματα διατροφής έχουν θετικές ή αρνητικές επιπτώσεις στην υγεία του πληθυσμού;'
    ]).size()
